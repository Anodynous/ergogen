...
module.exports = {
    ...
    body: p => {
        return `    
        (module "SOIC-8_5.23x5.23mm_P1.27mm" (layer F.Cu) (tedit 0)
        ...
        ${''/* pins */}
        (pad "1" smd roundrect (at -3.6 -1.905 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.CS.str})
        (pad "2" smd roundrect (at -3.6 -0.635 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.DO.str})
        (pad "3" smd roundrect (at -3.6 0.635 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.WP.str})
        (pad "4" smd roundrect (at -3.6 1.905 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.GND.str})
        (pad "5" smd roundrect (at 3.6 1.905 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.DI.str})
        (pad "6" smd roundrect (at 3.6 0.635 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.CLK.str})
        (pad "7" smd roundrect (at 3.6 -0.635 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.HLD.str})
        (pad "8" smd roundrect (at 3.6 -1.905 ${p.rot}) (size 1.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.25) ${p.net.VCC.str})
        )
        `
    }
}
